...
module.exports = {
	...
	execute(message)
	{
		if (!message.mentions.users.size) {
			...
			message.channel.send(`:sparkling_heart: ${AuthorDisplayName} Fixed ${SendMessage} Hair :sparkling_heart:`);
			...
			message.channel.send(`:sparkling_heart: ${AuthorDisplayName} Fixed ${MentionDisplayName} Hair :sparkling_heart:`);
