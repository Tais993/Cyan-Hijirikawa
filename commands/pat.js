...
module.exports = {
	...
	execute(message)
	{
		if (!message.mentions.users.size) {
			...
			message.channel.send(`:sparkling_heart: ${AuthorDisplayName} Pats ${SendMessage} :sparkling_heart:`);
			...
			message.channel.send(`:sparkling_heart: ${AuthorDisplayName} Pats ${MentionDisplayName} :sparkling_heart:`);
