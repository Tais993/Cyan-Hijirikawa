...
module.exports = {
	...
	execute(message)
	{
		if (!message.mentions.users.size) {
			...
			message.channel.send(`:sparkling_heart: ${AuthorDisplayName} Kissed ${SendMessage} :sparkling_heart:`);
			...
			message.channel.send(`:sparkling_heart: ${AuthorDisplayName} Kissed ${MentionDisplayName} :sparkling_heart:`);
